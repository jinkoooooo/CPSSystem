...
namespace serverForm
{
    class TextDB
    {
        ...
        public void insertJoin(memDB insertDB)
        {
            try
            {
                connectDB();
                ...
                mCommand.CommandText
                    = "insert into member(mem_name, mem_password, mem_departmer, mem_position, mem_jobyear, mem_number, mem_session)" +
                    " values('"+insertDB.mem_name+ "','" + insertDB.mem_password+ "'," + insertDB.mem_departmer+ "," + insertDB.mem_position
